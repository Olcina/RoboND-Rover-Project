...
def nothing(x):
    pass
#Color_detector modified to use rock_examples and selection of right RGB chanells for the Rover
...
while(1):
    ...
    #One's the mask only shows the rock we'll stop the search
